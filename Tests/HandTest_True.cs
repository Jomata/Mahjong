...
namespace Tests
{
    ...
    public class HandTest_True
    {
        ...
        {
            List<Tile> AllTiles = Hand.FromString("C1O1O9B1B9NOEASOWEWHWHGRREC9");
            bool expected = true;
            bool actual;
        ...
        {
            List<Tile> AllTiles = Hand.FromString("C1C9O1O9B1B9EASONOWEWHREGREA");
            bool expected = true; 
            bool actual;
            actual = ScorerJapanese.Is13Orphans(AllTiles);
            Assert.AreEqual(expected, actual);
        ...
        {
            List<Meld> Melds = Meld.FromString("B2B3B4 B2B3B4 B6B6B6 B8B8B8 GRGR",' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C2C3C4 o2o2o2 o6o7o8 b5b5 B6B7B8", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("EAEAEA WEWEWE SOSO WHWHWH GRGRGR", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C1C1C1 O1O1O1 O9O9O9 B1B1 B9B9B9", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C1C1C1 O9O9O9 B1B1B1 B9B9B9 GRGR", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C1C1 O1O1 B9B9 EAEA SOSO WHWH RERE", ' ');
            bool expected = true;
            bool actual;
            actual = ScorerJapanese.IsAllTerminalsAndHonors(Melds);
            Assert.AreEqual(expected, actual);
        ...
        {
            List<Meld> Melds = Meld.FromString("C8C8C8 O3O3O3 B1B1B1 B7B7B7 NONO", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("O3O3 EAEAEA SOSOSO WEWEWE NONONO", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C5C6C7 B4B4 WHWHWH GRGRGR RERERE", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("B1B2B3 B4B4B4 B5B5 B6B6B6 B7B8B9", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C9C9C9 B1B2B3 B4B5B6 B7B8B9 WHWH", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("O1O1O1 O3O4O5 O7O8O9 SOSO WHWHWH", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("B6B7B8 EAEAEA SOSOSO WEWEWE NONO", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("O2O3O4 B6B7B8 WHWHWH GRGRGR RERE", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C1C2C3 C5C5 O2O3O4 O7O8O9 B4B5B6", ' ');
            TileHonors PlayerWind = TileHonors.East;
            TileHonors GameWind = TileHonors.South;
            bool expected = true;
            bool actual;
            actual = ScorerJapanese.IsNoPointsHand(Melds, PlayerWind, GameWind, Melds.GetAllTiles().Find(t => t.ToString() == "[B4]"));
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            List<Meld> Melds = Meld.FromString("C2C3C4 O5O6O7 O5O6O7 B9B9B9 GRGR", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C3C3 O1O1 O5O5 B1B1 B8B8 EAEA RERE", ' ');
            bool expected = true;
            bool actual;
            actual = ScorerJapanese.IsSevenPairs(Melds);
            Assert.AreEqual(expected, actual);
        ...
        {
            List<Meld> Melds = Meld.FromString("C1C2C3 C9C9C9 O9O9 B1B2B3 B7B8B9", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C2C3C4 O1O1O1 B2B3B4 O2O3O4 SOSO", ' ');
            bool expected = true;
            bool actual;
        ...
        {
            List<Meld> Melds = Meld.FromString("C5C5 O7O8O9 O7O8O9 B7B8B9 B7B8B9", ' ');
            bool expected = true;
            bool actual;
